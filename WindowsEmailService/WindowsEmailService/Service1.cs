...
namespace WindowsEmailService
{
    public partial class Service1 : ServiceBase
    {
        ...
        public static void ScheduleService()
        {
            ...
            oMailClient.SendEmail("mateo.kostadinovic@vsmti.hr", "Naslov", "Hello World");
        ...
        {
            string path = "C:\\Fakultet\\Programiranje u .NET okolini\\WindowsEmailService\\EmailLog.txt";
